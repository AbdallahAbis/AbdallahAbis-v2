	...
	div {
		...
		@media ${device.large} {
			&:nth-child(1) {
				...
				animation-delay: ${({ noAnimations }) =>
					noAnimations ? '0.7s' : '3.4s'};
			}
...
`;
const Analytics = ({ data, noAnimations }) => {
	return (
		<Container noAnimations={noAnimations}>
			{data.map((info, i) => (
				<div key={i}>
					<span>
						<span>+</span>
